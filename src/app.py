...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice team drills and play matches against other schools",
    ...
    "Art Studio": {
        ...
        "max_participants": 15,
        "participants": ["lila@mergington.edu", "jordan@mergington.edu"]
    },
    "Music Ensemble": {
        "description": "Practice musical pieces and perform as a group",
        "schedule": "Tuesdays and Thursdays, 4:30 PM - 6:00 PM",
        "max_participants": 16,
        "participants": ["sophia@mergington.edu", "james@mergington.edu"]
    },
    "Debate Club": {
        "description": "Develop public speaking skills and debate current topics",
